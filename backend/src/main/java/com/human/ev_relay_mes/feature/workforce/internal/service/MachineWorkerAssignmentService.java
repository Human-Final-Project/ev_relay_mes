...
public class MachineWorkerAssignmentService implements WorkforceAssignmentLookup {
    ...
    private Machine findMachine(String machineId) {
        return machineRegistry.getRequiredMachine(machineId);
    }

    private Machine findMachineForUpdate(String machineId) {
        return machineRegistry.getRequiredMachineForUpdate(machineId);
    }
}
