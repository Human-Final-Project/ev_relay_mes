...
echo Starting six L1 simulators. OP30 will raise non-blocking WELD_TIP_WEAR_WARN after 3 products.
start "L1 EQ-WIND-01 - OP20" /D "!L1_DIR!" "!L1_EXE!" EQ-WIND-01
start "L1 EQ-WELD-01 - OP30 WARNING ALARM" /D "!L1_DIR!" "!L1_EXE!" EQ-WELD-01 127.0.0.1 9000 --alarm WELD_TIP_WEAR_WARN --error-after 3
...
echo.
echo Fixed OP30 warning demo started. Production will continue without RESUME.
endlocal
